...
describe("Avatar", () => {
  ...
  it("Displays url correctly", () => {
    ...
    cy.should(
      "have.attr",
      "src",
      "https://images.unsplash.com/photo-1689613188405-a216e5a53fe8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&q=200"
    );
  });
